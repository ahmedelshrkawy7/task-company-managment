...
import icon4 from '../../assets/cpu-setting.svg'
import icon5 from '../../assets/people.svg'
import icon6 from '../../assets/setting-2.svg'
import icon7 from '../../assets/circle.svg'
...
export {
  icon1,icon2,icon3,icon4,icon5,icon6,icon7,icon8,arrowR,arrowD,logo
}