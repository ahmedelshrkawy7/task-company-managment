...
title: Yup.string('title shuold be string').required('title is required *'),
 ...
 const handleSelect=(e,name,id)=>{
   ...
   switch(name){
     ...
     case 'employee_ids':
       ...
       formik.setFieldValue('project_teams',  [...formik.values.project_teams, { ...obj_api , [name]:index}])
...
//    }
  ...
  const handleSubmit= async()=>{ 
    ...
    await axios({
     method: "post",
     url: `${server}/ProjectPhases/${id}/phases`,
     data: formik.values,
  ...
  return (
   ...
   <div className='dash__form'>
      ...
      <div className='dash__form-content'>
          ...
          <div>
            <p>Start Date</p>
            <input name='start' type='date' onChange={formik.handleChange} ></input>
          </div>
          
          <div>
            <p>Deadline</p>
            <input name='end' type='date'   onChange={formik.handleChange}></input>
          </div>
          <div>
            <p>Status</p>
          ...
          <div>
            <p>Priority</p>
            <select name='priority'  onChange={formik.handleChange} >
       ...
       <div className='dash__form-content_projdetails'>
            ...
            <div className='dash__form-content_projdetails-input'>
             <textarea rows="4" cols="50" name='phase_discription'  onChange={formik.handleChange}></textarea> 
          ...
          <Addinput header='Phase Delivrables' placeholder= 'Create home page' fun={updateArray} keyName='target'/>
       ...
       <button type='submit'  value='clcik' ref={submitBtn}  style={{width:'50px' , height:'50px'}} hidden></button>
   </form>
